...
| TLS/HTTP/2/HTTP/3 identity coherence | [Module 07](docs/modules/07-protocol-identity/index.md) | generated ClientHello and loopback HTTP observer | Core complete; fingerprints explicitly not identity proof |
| Application-layer DDoS and mitigation assumptions | [Module 08](docs/modules/08-ddos-resilience/index.md) | seven hard-bounded k6 scenarios plus recovery/retest | Core complete for L7 |
