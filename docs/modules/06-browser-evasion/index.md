...
| 5. Replay and temporal consistency | [Replay and temporal consistency](04-replay-and-temporal-consistency.md) | Captured payload/token, nonce/timestamp/session/action binding, first action, replay result, and limits of the result |
