...
This optional appendix turns synthetic traffic observations into confidence-
bounded intelligence, indicator lifecycle decisions, authorized emulation, and
exact regression tests. It has no core prerequisite and is excluded from every
checkpoint.
...
hostnames. It performs no network request and cannot attribute a real actor.

Start with [Collection and confidence](01-collection-and-confidence.md), or
return to [HTTP request and response](../../modules/01-http-edge/01-http-request-response.md).
