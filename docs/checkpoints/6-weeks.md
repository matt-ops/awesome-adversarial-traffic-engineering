...
| `m01-l04` | [Map the edge request path](../modules/01-http-edge/04-edge-request-path.md) | Applied | 100 |
...
| `m06-l04` | [Replay and temporal consistency](../modules/06-browser-evasion/04-replay-and-temporal-consistency.md) | Integrated | 180 |
| `m06-l05` | [Version drift and residual anomalies](../modules/06-browser-evasion/05-version-drift-and-residual-anomalies.md) | Deep | 240 |
| `m07-l01` | [TLS ClientHello](../modules/07-protocol-identity/01-tls-clienthello.md) | Foundation | 180 |
...
| `m09-l04` | [Secure code review through an adversary's path](../modules/09-tooling-code-review/04-secure-code-review.md) | Integrated | 300 |
| `m10-l01` | [Finding and evidence](../modules/10-findings-interview/01-finding-and-evidence.md) | Foundation | 180 |
| `m10-l02` | [Remediation and exact retest](../modules/10-findings-interview/02-remediation-and-retest.md) | Applied | 180 |
| `m10-l03` | [Technical briefing](../modules/10-findings-interview/03-technical-briefing.md) | Integrated | 180 |
| `m10-l04` | [Public-safe role narrative](../modules/10-findings-interview/04-role-narrative.md) | Foundation | 120 |
...
Complete a full bounded mock loop that connects authorization, baselines, controlled change, protected-action or service-health proof, remediation, exact retest, and limitations.
